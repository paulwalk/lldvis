...
Topic.create(:name => "USE.COMPU", :topiccluster_id => topiccluster.id)
...
usecasecluster = Usecasecluster.create(:name => 'Citations')
  usecase = Usecase.create(:usecasecluster_id => usecasecluster.id,:name => "Citation of Scientific Datasets")
